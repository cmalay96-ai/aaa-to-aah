      ...
      <section className="relative py-20 px-4 bg-sea-radial text-center overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-6 relative z-10">
          ...
          <p className="text-textSecondary text-base md:text-lg font-light leading-relaxed max-w-xl mx-auto">
            We have received your details for the <strong className="text-primary font-bold">FREE 10-Minute Home Recovery Demo</strong>. A recovery counselor is verifying specialist availability in your area.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-poppins font-bold text-textPrimary mb-2">1. Detail Verification</h3>
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-poppins font-bold text-textPrimary mb-2">2. Timing Call</h3>
              <p className="text-textSecondary text-xs leading-relaxed font-light">
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-poppins font-bold text-textPrimary mb-2">3. Home Session</h3>
              <p className="text-textSecondary text-xs leading-relaxed font-light">
