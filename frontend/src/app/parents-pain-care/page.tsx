        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 space-y-6 text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-serif text-textPrimary leading-tight tracking-tight">
              ...
              <span className="text-primary italic">Move Comfortably Again.</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-poppins font-semibold text-textPrimary">Gentle Assisted Stretching for Seniors</span>
              </div>
              <div className="flex items-center gap-3">
                <FaCheckCircle className="text-primary flex-shrink-0 text-lg" />
                <span className="text-sm font-poppins font-semibold text-textPrimary">Eases Age-Related Knee & Hip Stiffness</span>
              </div>
              <div className="flex items-center gap-3">
                <FaCheckCircle className="text-primary flex-shrink-0 text-lg" />
                <span className="text-sm font-poppins font-semibold text-textPrimary">Background-Verified Safe Therapists</span>
              </div>
              <div className="flex items-center gap-3">
                <FaCheckCircle className="text-primary flex-shrink-0 text-lg" />
                <span className="text-sm font-poppins font-semibold text-textPrimary">Performed Comfortably on Couch or Bed</span>
              </div>
            </div>
            ...
            <div className="p-5 bg-white/90 border border-primary/10 rounded-2xl flex items-center gap-4 max-w-lg mt-6 shadow-[0_4px_20px_-4px_rgba(10,77,60,0.04)]">
              ...
              <div>
                <h4 className="text-sm font-poppins font-bold text-textPrimary">Free Home Demo For Parents</h4>
                <p className="text-xs text-textSecondary mt-0.5 font-medium">Let us show them gentle relief. Includes a <span className="text-primary font-bold">FREE 10-Minute Seniors Home Recovery Assessment & Demo</span>.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-surface border-t border-primary/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h3 className="text-xs font-montserrat font-bold text-primary uppercase tracking-wider">TRUSTED CARE</h3>
            <h2 className="text-2xl md:text-4xl font-serif text-textPrimary mt-2">Gentle Mobility Care For Elders</h2>
          </div>
          <div className="relative h-[250px] md:h-[450px] w-full rounded-3xl overflow-hidden border border-primary/10 group shadow-md">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
              <div className="max-w-md bg-white/90 backdrop-blur-sm p-5 rounded-2xl border border-primary/10 shadow-sm">
                ...
                <h4 className="text-lg md:text-xl font-poppins font-bold text-textPrimary mt-1">FREE Home Recovery Demo for Parents</h4>
                <p className="text-xs text-textSecondary mt-1 font-medium">Our certified specialists perform highly slow, patient, and therapeutic passive stretching to help elders stand, sit, and walk with greater physical confidence.</p>
              </div>
              <button 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-surface border border-primary/10 p-8 rounded-2xl hover:border-primary/30 hover:shadow-lg transition-all duration-300 group">
              <FaUserHeart className="text-4xl text-primary mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-serif text-textPrimary mb-3">Extreme Patience</h3>
            ...
            {/* Card 2 */}
            <div className="bg-surface border border-primary/10 p-8 rounded-2xl hover:border-primary/30 hover:shadow-lg transition-all duration-300 group">
              <FaHeart className="text-4xl text-primary mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-serif text-textPrimary mb-3">Reduces Discomfort</h3>
              <p className="text-textSecondary text-sm leading-relaxed font-medium">
            ...
            {/* Card 3 */}
            <div className="bg-surface border border-primary/10 p-8 rounded-2xl hover:border-primary/30 hover:shadow-lg transition-all duration-300 group">
              <FaHandsHelp className="text-4xl text-primary mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-serif text-textPrimary mb-3">Supports Daily Balance</h3>
              <p className="text-textSecondary text-sm leading-relaxed font-medium">
      ...
      <section className="py-20 px-4 bg-surface border-t border-primary/10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <span className="text-xs font-montserrat font-bold text-primary uppercase">SAFETY-FIRST PROTOCOLS</span>
            ...
            <div className="flex gap-6 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-poppins font-bold uppercase text-textPrimary">100% In-Home Safelanding</span>
              </div>
              <div className="flex items-center gap-2">
                <FaClock className="text-primary text-lg" />
                <span className="text-xs font-poppins font-bold uppercase text-textPrimary">No Hospitalization stress</span>
              </div>
            </div>
          </div>
        </div>
