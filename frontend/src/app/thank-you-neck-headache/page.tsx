...
export default function ThankYouNeckHeadachePage() {
  return (
    <div className="bg-background min-h-screen text-textPrimary font-sans antialiased overflow-x-hidden selection:bg-primary/10 selection:text-primary">
      ...
      <header className="py-6 px-4 border-b border-primary/10 bg-white/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <Link href="/neck-headache-relief">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-[#090b16] to-brandBlack text-center overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-6 relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-serif text-textPrimary leading-tight tracking-tight">
            Neck Release Demo Registered! <br />
            <span className="text-primary italic">
              Your Path to a Strain-Free Life Is Coming.
            </span>
          </h1>
          
          <p className="text-textSecondary text-base md:text-lg font-light leading-relaxed max-w-xl mx-auto">
            We've successfully received your booking for a <strong className="text-primary font-bold">FREE 10-Minute Neck & Headache Relief Home Demo</strong>. A counselor is lining up certified recovery therapists.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 max-w-md mx-auto">
            {/* WhatsApp CTA Button */}
            <a
              href="https://wa.me/917908082151?text=Hi!%20I%20just%20submitted%20the%20form%20for%20a%20FREE%20Neck%20and%20Headache%20Relief%20Home%20Demo%20on%20AAATOAHH.IN.%20Please%20confirm%20my%20slot!"
              target="_blank"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-poppins font-bold text-textPrimary mb-2">1. Therapist Allocation</h3>
              <p className="text-textSecondary text-xs leading-relaxed font-light">
                We select a background-verified therapist experienced in deep neck decompressions, suboccipital release, and desk posture correction.
              </p>
            </div>
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-textSecondary text-xs leading-relaxed font-light">
                We contact you to coordinate a convenient timing—whether it's after office hours, early morning, or on a weekend.
              </p>
            </div>
            ...
            <div className="bg-surface border border-primary/10 shadow-sm hover:border-primary/30 transition-all duration-300 p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-poppins font-bold text-textPrimary mb-2">3. Neck & Headache Release</h3>
              <p className="text-textSecondary text-xs leading-relaxed font-light">
                Our specialist performs a gentle 10-minute demo session in the privacy of your home to release skull-base tension instantly.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 4. Testimonials (Sleep/Stress theme) */}
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/joint-pain-relief" className="bg-surface hover:bg-secondary/40 border border-primary/10 shadow-sm p-4 rounded-xl transition-all duration-300 group">
              <span className="text-lg block group-hover:scale-110 transition-transform">Bone</span>
